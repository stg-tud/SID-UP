...
class ReactiveTextField() extends ReactiveComponent(new JTextField()) with ReactiveCommittable with ReactiveInput[String] {
  ...
  override val value: Signal[String] = _text
  override def setValue(value: String) = asComponent.setText(value)
}